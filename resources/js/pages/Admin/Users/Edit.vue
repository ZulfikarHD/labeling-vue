...
import { ArrowLeft, Eye, EyeOff, Lock, Save, UserPen } from 'lucide-vue-next';
...
/**
 * Form untuk edit user menggunakan Inertia useForm
 * dengan initial data dari props
 */
const form = useForm({
    name: props.user.name || '',
    password: '',
    role: props.user.role,
    workstation_id: props.user.workstation_id || '',
...
/**
 * Handle form submission dengan PUT method
 */
    ...
    <AppLayout title="Edit User">
        <div class="mx-auto max-w-2xl space-y-6">
            ...
            >
                ...
                <h1 class="mt-4 font-display text-2xl font-bold text-gray-900 dark:text-white">Edit User</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui informasi user {{ user.np }}</p>
            </div>
            ...
            >
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div class="flex justify-center">
                        <div
                            class="flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-amber-500 to-amber-600 shadow-lg shadow-amber-500/25"
                        >
                            <UserPen class="h-8 w-8 text-white" :stroke-width="2" />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <input
                            ...
                            type="text"
                            disabled
                            class="mt-1 block w-full cursor-not-allowed rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-gray-500 dark:border-zinc-600 dark:bg-zinc-800 dark:text-gray-400"
                        />
                    ...
                    <!-- Submit Button -->
                    <div
                        class="flex gap-3 pt-4 transition-all delay-[450ms] duration-500"
                        :class="[isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0']"
                    >
                        <Link
                            href="/admin/users"
