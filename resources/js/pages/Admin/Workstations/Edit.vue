...
/**
 * Form untuk edit workstation menggunakan Inertia useForm
 * dengan initial data dari props
 */
const form = useForm({
    name: props.workstation.name,
    is_active: props.workstation.is_active,
});
...
function handleSubmit(): void {
    vibrate();
    form.put(`/admin/workstations/${props.workstation.id}`, {
        preserveScroll: true,
    });
}
...
<template>
    <AppLayout title="Edit Workstation">
        <div class="mx-auto max-w-2xl space-y-6">
            ...
            >
                ...
                <h1 class="mt-4 font-display text-2xl font-bold text-gray-900 dark:text-white">Edit Workstation</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Perbarui informasi workstation {{ workstation.name }}
                </p>
            </div>
